...
{
#if defined(DEBUG) || defined(SAMMYC21) || defined(CANNED_ERCF_SAMMYC21) || defined(RPI_PICO) || defined(FLY36RRF) || defined(FLYSB2040v1_0) || defined(MKSTHR36v1_0)	// save on stack usage by not calling vuprintf if debugging is disabled
	va_list vargs;
	va_start(vargs, fmt);
